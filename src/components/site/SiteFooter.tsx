        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2">
              <span className="inline-flex h-7 w-7 items-center justify-center rounded-md bg-foreground text-background text-[11px] font-semibold">AV</span>
              <span className="font-semibold tracking-tight">Axiom Visibility</span>
            </div>
          ...
          <FooterCol title="Resources">
            ...
            <a href="mailto:hello@axiomvisibility.com" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Email</a>
          </FooterCol>
        </div>

        <div className="mt-14 pt-6 hairline-t flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Axiom Visibility. All rights reserved.
          </p>
